...
ActiveRecord::Schema.define(version: 2020_11_07_062253) do
  ...
  create_table "bad_usres", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["user_id"], name: "index_bad_usres_on_user_id"
  end
  ...
  add_foreign_key "bad_usres", "users"
